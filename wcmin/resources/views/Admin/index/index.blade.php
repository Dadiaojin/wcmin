...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="{{asset("/aboutHui.shtml")}}">H-ui.admin</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="{{asset("/aboutHui.shtml")}}">H-ui</a> 
			...
			<dd>
				<ul>
					...
					<li><a data-href="{{url("admin/category")}}" data-title="分类管理" href="javascript:void(0)">分类管理</a></li>
                                        <li><a data-href="{{url("admin/categorylist")}}" data-title="分类管理" href="javascript:void(0)">分类列表</a></li>
