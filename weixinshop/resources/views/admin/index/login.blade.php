    ...
    <form class="form form-horizontal" action="{{url('admin/login')}}" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img src="{{captcha_src()}}" onclick="this.src='{{captcha_src()}}'+Math.random()" id="captcha"> <a id="kanbuq" href=""  onclick="document.getElementById('captcha').src='{{captcha_src()}}'+Math.random()"> 看不清，换一张</a> </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
