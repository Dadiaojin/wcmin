	...
	<form class="form form-horizontal" id="form-goods-add" enctype="multipart/form-data">
		...
		<div class="row cl">
           ...
           <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
                            ...
                            <select name="cat_id">
                                ...
                                @foreach($cat_id as $v)
                         <option value ="{{$v->id}}"  @if($v->id==$goods->cat_id) selected="selected" @endif >{{$v->cat_name}}</option>
                        @endforeach
                        </select>
           ...
           <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
                            <input type="text" class="input-text" value="{{$goods->goods_price}}" placeholder="" id="" name="goods_price">
			</div>
		</div>
			...
			<div class="formControls col-xs-8 col-sm-9">
                            <input type="number" class="input-text" value="{{$goods->stock}}" placeholder="" id="" name="stock">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="{{$goods->goods_desc}}" placeholder="" id="" name="goods_desc">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-thum-container">
                                    <input type="text" class="input-text" value="{{$goods->goods_thumb}}" placeholder="" id="goods_thumb" name="goods_thumb">
...
$("#form-goods-add").submit(function(event){
	...
	$.ajax({
		type:'post',
		url:'{{url("admin/goods/update/")}}/{{$goods->id}}',
		data:data,
		dataType:"json",
